...
export const HowItWorksPage: React.FC = () => {
  ...
  return (
    <div className="space-y-8 pb-16 max-w-5xl mx-auto">
      ...
      <div className="space-y-6">
        {pipelineSteps.map((step, idx) => {
          ...
          return (
            <div
              key={idx}
              className="rounded-2xl bg-[#111827] border border-slate-800 p-6 sm:p-8 shadow-xl hover:border-cyan-500/40 transition-all"
            >
              <div className="flex flex-col sm:flex-row sm:items-start gap-4 mb-4">
                <div className="w-12 h-12 rounded-xl bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 flex items-center justify-center font-mono font-bold text-lg flex-shrink-0">
                  {step.step}
                </div>
              ...
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed mb-4 pl-0 sm:pl-16">
                {step.desc}
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pl-0 sm:pl-16 pt-3 border-t border-slate-800/80">
                {step.bullets.map((b, bIdx) => (
                  <div key={bIdx} className="flex items-center gap-2 text-xs text-slate-400 font-mono">
      ...
      <div className="rounded-2xl bg-[#111827] border border-slate-800 p-6 sm:p-8 shadow-xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs font-mono">
          <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800 space-y-2">
            <span className="text-cyan-400 font-bold block">1. INGESTION ENGINE</span>
          ...
          <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800 space-y-2">
            <span className="text-cyan-400 font-bold block">2. MACHINE INTELLIGENCE</span>
            <div className="text-slate-300 space-y-1">
          ...
          <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800 space-y-2">
            <span className="text-cyan-400 font-bold block">3. FORENSICS & CLIENT</span>
            <div className="text-slate-300 space-y-1">
      ...
      {/* Action Footer */}
      <div className="rounded-2xl bg-gradient-to-r from-cyan-950/50 via-slate-900 to-blue-950/50 border border-cyan-500/30 p-8 shadow-2xl text-center space-y-4">
        <h3 className="text-2xl font-bold text-white">Experience the Ocean Sentinel Platform</h3>
