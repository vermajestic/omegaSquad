    ...
    <div className="space-y-6 pb-14">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="p-4 rounded-xl bg-[#111827] border border-slate-800 shadow-lg">
          <span className="text-[11px] uppercase font-bold text-slate-400 flex items-center gap-1.5 mb-1">
            <TrendingUp className="w-3.5 h-3.5 text-cyan-400" /> Total Detections
          </span>
          <div className="text-2xl font-bold font-mono text-white">106</div>
          <span className="text-[10px] text-emerald-400 font-semibold">+14% vs prior year</span>
        </div>

        <div className="p-4 rounded-xl bg-[#111827] border border-slate-800 shadow-lg">
          <span className="text-[11px] uppercase font-bold text-slate-400 flex items-center gap-1.5 mb-1">
            <ShieldCheck className="w-3.5 h-3.5 text-emerald-400" /> Mean Confidence
          </span>
          <div className="text-2xl font-bold font-mono text-emerald-400">86.4%</div>
          <span className="text-[10px] text-slate-500">Sentinel-1 C-SAR verified</span>
        </div>

        <div className="p-4 rounded-xl bg-[#111827] border border-slate-800 shadow-lg">
          <span className="text-[11px] uppercase font-bold text-slate-400 flex items-center gap-1.5 mb-1">
            <Activity className="w-3.5 h-3.5 text-red-400" /> Cumulative Slick Area
          </span>
          <div className="text-2xl font-bold font-mono text-red-400">142.3 km²</div>
          <span className="text-[10px] text-slate-500">Total detected surface</span>
        </div>

        <div className="p-4 rounded-xl bg-[#111827] border border-slate-800 shadow-lg">
          <span className="text-[11px] uppercase font-bold text-slate-400 flex items-center gap-1.5 mb-1">
            <Award className="w-3.5 h-3.5 text-amber-400" /> Attribution Success
          </span>
          <div className="text-2xl font-bold font-mono text-cyan-400">78.2%</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="p-5 rounded-xl bg-[#111827] border border-slate-800 shadow-xl">
          <div className="flex items-center justify-between pb-3 border-b border-slate-800 mb-4">
            <div>
              <h3 className="text-sm font-bold text-white uppercase tracking-wider">
                Oil Spill Detections Over Time
              </h3>
              <p className="text-xs text-slate-400">Monthly incident incidence count</p>
            </div>
            <span className="text-xs font-mono text-cyan-400 font-bold">12 Months Trend</span>
          </div>
          ...
          <div className="h-60 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={mockAnalyticsData.detectionsOverTime}>
                ...
                <RechartsTooltip
                  contentStyle={{ backgroundColor: '#0a0f1e', borderColor: '#334155', borderRadius: 8, fontSize: 12 }}
                />
        ...
        <div className="p-5 rounded-xl bg-[#111827] border border-slate-800 shadow-xl">
          <div className="flex items-center justify-between pb-3 border-b border-slate-800 mb-4">
            <div>
              ...
              <p className="text-xs text-slate-400">Square kilometers (km²) of hydrocarbons detected</p>
            </div>
            <span className="text-xs font-mono text-red-400 font-bold">Area (km²)</span>
          </div>
        ...
        <div className="p-5 rounded-xl bg-[#111827] border border-slate-800 shadow-xl">
          <div className="flex items-center justify-between pb-3 border-b border-slate-800 mb-4">
            <div>
              ...
              <p className="text-xs text-slate-400">Incident count across model confidence brackets</p>
            </div>
            <span className="text-xs font-mono text-emerald-400 font-bold">Model v3</span>
          </div>
        ...
        <div className="p-5 rounded-xl bg-[#111827] border border-slate-800 shadow-xl">
          <div className="flex items-center justify-between pb-3 border-b border-slate-800 mb-4">
            <div>
              ...
              <p className="text-xs text-slate-400">Legal investigation resolution categories</p>
            </div>
            <span className="text-xs font-mono text-cyan-400 font-bold">56 Total Cases</span>
          </div>
        ...
        <div className="p-5 rounded-xl bg-[#111827] border border-slate-800 shadow-xl">
          <div className="flex items-center justify-between pb-3 border-b border-slate-800 mb-4">
            ...
            <span className="text-xs font-mono text-slate-400 font-bold">Active Records</span>
          </div>
        ...
        <div className="p-5 rounded-xl bg-[#111827] border border-slate-800 shadow-xl">
          <div className="flex items-center justify-between pb-3 border-b border-slate-800 mb-4">
            <div>
              ...
              <p className="text-xs text-slate-400">Spills detected by maritime basin</p>
            </div>
            <span className="text-xs font-mono text-amber-400 font-bold">Arabian Sea Peak</span>
          </div>
