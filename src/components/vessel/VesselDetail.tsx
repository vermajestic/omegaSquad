      ...
      <div className="flex items-start justify-between pb-4 border-b border-slate-800 mb-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <span className="text-xs font-mono font-bold text-cyan-400">IMO {imo}</span>
            <span
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div className="p-3 rounded-lg bg-slate-900/60 border border-slate-800">
          <span className="text-[10px] uppercase font-semibold text-slate-400 flex items-center gap-1 mb-1">
            <MapPin className="w-3 h-3 text-amber-400" /> Closest Approach
          </span>
        ...
        <div className="p-3 rounded-lg bg-slate-900/60 border border-slate-800">
          <span className="text-[10px] uppercase font-semibold text-slate-400 flex items-center gap-1 mb-1">
            <Gauge className="w-3 h-3 text-cyan-400" /> Transit Speed
          </span>
          <div className="text-sm font-bold font-mono text-slate-200">
            13.5 kts
          </div>
          <div className="text-[10px] text-red-400 mt-0.5 font-medium">Dropped from 14.2 kts</div>
        </div>
      </div>

      {/* Technical Specifications */}
      <div className="space-y-2 py-3 border-y border-slate-800/80 text-xs text-slate-300 mb-4">
        <div className="flex justify-between">
          <span className="text-slate-400">Vessel Category:</span>
          <span className="font-medium text-slate-200">{type} (Aframax Class)</span>
        </div>
        <div className="flex justify-between">
          <span className="text-slate-400">Flag State / Callsign:</span>
          <span className="font-mono text-slate-200">Panama (PA) • 3E2144</span>
        </div>
        <div className="flex justify-between">
          <span className="text-slate-400">MMSI Transponder:</span>
          <span className="font-mono text-slate-200">354892000</span>
        </div>
        <div className="flex justify-between">
          <span className="text-slate-400">Dimensions (LOA × Beam):</span>
          <span className="font-mono text-slate-200">244m × 42m</span>
        </div>
        <div className="flex justify-between">
          <span className="text-slate-400">Current Draught / DWT:</span>
          <span className="font-mono text-slate-200">14.2m / 105,400 DWT</span>
        </div>
        <div className="flex justify-between">
          <span className="text-slate-400">Reported Destination:</span>
          <span className="font-medium text-cyan-300">Mundra, IN (ETA: Sep 06)</span>
        </div>
      </div>
