...
export const ReportsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 pb-16 max-w-5xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-5 print:hidden">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs font-mono font-bold text-cyan-400">MARPOL ANNEX I ENFORCEMENT REPORT</span>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <select
            ...
            className="bg-[#111827] border border-slate-700/80 rounded-lg px-3 py-2 text-xs font-semibold text-slate-200 focus:outline-none focus:border-cyan-500 cursor-pointer"
          >
      ...
      <div className="bg-[#111827] border border-slate-800 rounded-2xl p-8 sm:p-12 shadow-2xl space-y-8 text-slate-200 print:bg-white print:text-black print:border-none print:shadow-none print:p-0">
        {/* Document Header */}
        <div className="border-b border-slate-800 pb-6 print:border-black">
          <div className="flex justify-between items-start">
            <div>
              <div className="text-[11px] font-mono tracking-widest text-cyan-400 font-bold uppercase print:text-black">
                GOVERNMENT OF INDIA • COAST GUARD SURVEILLANCE FLEET
              </div>
              <h2 className="text-2xl font-black tracking-tight text-white mt-1 print:text-black">
                MARINE HYDROCARBON SPILL ATTRIBUTION DOSSIER
              </h2>
              <div className="text-xs text-slate-400 font-mono mt-1 print:text-gray-600">
                Official Case File: <strong className="text-slate-200 print:text-black">{incident.id}</strong> • Sector: {incident.region}
              </div>
            </div>

            <div className="text-right">
              <span className="px-3 py-1 rounded bg-red-950 text-red-400 border border-red-800 text-xs font-mono font-bold uppercase print:border-black print:text-black print:bg-gray-100">
                MARPOL TIER 1 EVIDENCE
              </span>
              <div className="text-[11px] font-mono text-slate-400 mt-2 print:text-gray-600">
        ...
        <section className="space-y-2">
          <h3 className="text-sm font-bold uppercase tracking-wider text-cyan-400 border-b border-slate-800 pb-1 print:text-black print:border-black">
        ...
        <section className="space-y-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs font-mono">
            <div className="p-2.5 rounded bg-slate-900 border border-slate-800 print:bg-gray-50 print:border-gray-300">
              <span className="text-slate-500">Constellation:</span>
              <div className="font-bold text-slate-200 print:text-black">{incident.satellite || 'Sentinel-1A'}</div>
            </div>
            <div className="p-2.5 rounded bg-slate-900 border border-slate-800 print:bg-gray-50 print:border-gray-300">
              <span className="text-slate-500">Instrument:</span>
              <div className="font-bold text-slate-200 print:text-black">{incident.sensor || 'C-SAR'} (Interferometric Wide)</div>
            </div>
            <div className="p-2.5 rounded bg-slate-900 border border-slate-800 print:bg-gray-50 print:border-gray-300">
              <span className="text-slate-500">Spatial Resolution:</span>
              <div className="font-bold text-cyan-400 print:text-black">10 meters / pixel</div>
            </div>
            <div className="p-2.5 rounded bg-slate-900 border border-slate-800 print:bg-gray-50 print:border-gray-300">
              <span className="text-slate-500">Polarization:</span>
              <div className="font-bold text-slate-200 print:text-black">VV + VH Dual-Pol</div>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs font-mono">
            <div className="p-2.5 rounded bg-slate-900 border border-slate-800 print:bg-gray-50 print:border-gray-300">
              <span className="text-slate-500">Center Geographic Coordinates:</span>
            ...
            <div className="p-2.5 rounded bg-slate-900 border border-slate-800 print:bg-gray-50 print:border-gray-300">
              ...
              <div className="font-bold text-red-400 print:text-black">
                {formatArea(incident.estimatedArea ?? 12.4)}
              </div>
            </div>
            <div className="p-2.5 rounded bg-slate-900 border border-slate-800 print:bg-gray-50 print:border-gray-300">
              <span className="text-slate-500">Drift Vector:</span>
              <div className="font-bold text-slate-200 print:text-black">1.2 kts @ 142° SE</div>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-2">
          ...
          <div className="space-y-1 text-xs">
            {(incident.analysisIndicators || []).map((ind, idx) => (
              <div key={idx} className="flex justify-between py-1 border-b border-slate-800/60 print:border-gray-200">
                <span className="text-slate-300 print:text-black">{ind.name.replace(/_/g, ' ').toUpperCase()}</span>
                <span className="font-mono font-bold text-cyan-400 print:text-black">{ind.score}%</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="space-y-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs font-mono">
            <div className="p-2.5 rounded bg-slate-900 border border-slate-800 print:bg-gray-50 print:border-gray-300">
              ...
              <div className="font-bold text-cyan-300 print:text-black">{topVessel.name}</div>
            </div>
            <div className="p-2.5 rounded bg-slate-900 border border-slate-800 print:bg-gray-50 print:border-gray-300">
              <span className="text-slate-500">IMO / MMSI:</span>
              <div className="font-bold text-slate-200 print:text-black">{topVessel.imo} / 354892000</div>
            </div>
            <div className="p-2.5 rounded bg-slate-900 border border-slate-800 print:bg-gray-50 print:border-gray-300">
              <span className="text-slate-500">Flag State:</span>
              <div className="font-bold text-slate-200 print:text-black">Panama (Callsign: 3E2144)</div>
            </div>
            <div className="p-2.5 rounded bg-slate-900 border border-slate-800 print:bg-gray-50 print:border-gray-300">
              <span className="text-slate-500">Classification:</span>
              <div className="font-bold text-slate-200 print:text-black">Crude Oil Tanker (105,400 DWT)</div>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
            {attribution.evidence.map((ev, idx) => (
              <div key={idx} className="p-3 rounded bg-slate-900 border border-slate-800 print:bg-gray-50 print:border-gray-300 space-y-1">
                <div className="flex justify-between font-bold">
                  <span className="text-slate-200 print:text-black">{ev.name}</span>
                  <span className="text-cyan-400 font-mono print:text-black">{ev.score}% (Weight: {Math.round(ev.weight * 100)}%)</span>
                </div>
                <p className="text-[11px] text-slate-400 leading-relaxed print:text-gray-700">{ev.description}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="space-y-2">
          ...
          <ul className="list-disc list-inside text-xs text-slate-300 space-y-1.5 print:text-black">
        ...
        {/* Document Footer */}
        <div className="pt-6 border-t border-slate-800 flex justify-between items-end text-[11px] text-slate-500 font-mono print:border-black print:text-gray-600">
          <div>
